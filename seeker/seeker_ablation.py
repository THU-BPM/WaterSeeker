...
if __name__ == '__main__':
    ...
    with open(args.output_file, 'w') as f:
        for d in tqdm(data):
            ...
            strength = 0
            if flag:
                strength = loaded_data['strength']

            # detect result: {'is_watermarked': bool, 'indices': List[int]}
            detect_result = watermark.detect_watermark_with_seeker_phase_1(text=text,
            ...
            f.write(json.dumps({'predicted': is_watermarked, 'indices': indices, 'gold': flag, 'gold_indices': segments, 'strength': strength}) + '\n')
